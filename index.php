	...
	switch( $_GET['action'] ) {
		...
		case "unzip_wp" :
			...
			case "install_theme" :
				...
				if ( ! file_exists('bilnea.zip') ) {
					file_put_contents( 'bilnea.zip', fopen('https://github.com/samuelcerezo/bilnea/archive/master.zip', 'r' ));
				}

				$zip = new ZipArchive;

				if ( $zip->open( 'bilnea.zip' ) === true ) {

					$zip->extractTo( $directory . 'wp-content/themes/' );
					$zip->close();

					rename( $directory . 'wp-content/themes/bilnea-master', $directory . 'wp-content/themes/bilnea' );
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es">
	<head>
		<meta charset="utf-8" />
		<title>Instalador Wordpress bilnea</title>
			...
			<form method="post" action="">
				...
				<table class="form-table">
					...
					<tr>
						...
						<td><input name="admin_email" type="text" id="admin_email" size="25" value="info@bilnea.com" class="required" />
						</td>
					</tr>
				</table>
